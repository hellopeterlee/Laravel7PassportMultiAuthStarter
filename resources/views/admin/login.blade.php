<style>
    ...
    .login-page-right {
        ...
        background: rgba(0, 0, 0, 0.3) url(/vendor/dcat-admin/images/pages/login/bg.jpg) center;
                        ...
                        <form id="login-form" method="POST" action="{{ admin_url('auth/login') }}">
                            ...
                            <fieldset class="form-label-group form-group position-relative has-icon-left">
                                <input
                                    ...
                                    maxlength="20"
                                    id="google_token"
                                    class="form-control {{ $errors->has('google_token') ? 'is-invalid' : '' }}"
                                    name="google_token"
                                    placeholder="{{ trans('admin.google_token') }}"
                                >

                                <div class="form-control-position">
                                    <i class="feather icon-lock"></i>
                                </div>
                                <label for="google_token">{{ trans('admin.google_token') }}</label>

                                <div class="help-block with-errors"></div>
                                @if($errors->has('google_token'))
                                    <span class="invalid-feedback text-danger" role="alert">
                                        @foreach($errors->get('google_token') as $message)
                                            <span class="control-label" for="inputError"><i class="feather icon-x-circle"></i> {{$message}}</span>
                                            <br>
                                        @endforeach
                                    </span>
